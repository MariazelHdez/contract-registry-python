...
async def process_row(row_data, browser, stop_script_flag, data_storage, semaphore):
    async with semaphore:
        ...
        try:
            ...
            await setup_captcha_handling(detail_page, detail_captcha_solved_event, stop_script_flag)
...
async def interactions(page, captcha_solved_event, stop_script_flag, browser):
    try:
        data_storage = []
        ...
        while True:
            ...
            for row_data in row_data_list:
                task = asyncio.ensure_future(process_row(row_data, browser, stop_script_flag, data_storage, semaphore))
                tasks.append(task)
            ...
            # print(f"Data collected after page {page_counter}:")
            # print(json.dumps(data_storage, indent=2))
